...
if Config.EnableDebug then
    ...
    AddEventHandler("esx:enteredVehicle", function(plate, seat, displayName, netId)
        print("esx:enteredVehicle", "source", source, "plate", plate, "seat", seat, "displayName", displayName, "netId",
            netId)
    end)

    AddEventHandler("esx:exitedVehicle", function(plate, seat, displayName, netId)
        print("esx:exitedVehicle", "source", source, "plate", plate, "seat", seat, "displayName", displayName, "netId",
            netId)
    end)
end
